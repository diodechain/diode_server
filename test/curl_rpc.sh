...
curl -k -H "Content-Type: application/json" -X POST --data '{"jsonrpc":"2.0","method":"eth_getTransactionReceipt","params":["0xfcbcff42883af6da36d53e97fad88562324b581361169de856c3feca2ab2a580"],"id":73}' $host
echo ""
