...
create_account(Value, CodeArea, State) ->
    ...
    ChainApi:create_account(Value, CodeArea, State).
...
recursive_call2(Op, Gascap, To, Value, OSize, OOffset, I, State8, GasAfterSpend, OutType, GasIsLimited) ->
    ...
    case aevm_eeevm_state:no_recursion(State8) of
        true  -> %% Just set up a call for testing without actually calling.
            ...
            {1, State10};
        false ->
            case aevm_eeevm_state:call_contract(Caller, Dest, To, CallGas, Value, I, State8) of
                ...
                {exception, What, GasSpent, OutState1} ->
